  ...
  return (
    <section className='space-y-5'>
      ...
      <Card className='p-8 bg-neutral-100 border dark:border-none rounded-xl space-y-4'>
        ...
        Currently on the lookout for a Software Engineer / Full Stack Developer Internship for Summer 2024. Eager to leverage my skills in contributing to innovative projects. Please feel free to reach out to me, and let's discuss how my expertise aligns with your organization's goals..
        </p>
        <Button
